...
public interface PlayerJpaRepository extends JpaRepository<PlayerEntity, Long> {
    ...
    Optional<PlayerEntity> findByUserNameAndPassword(String usernameIdentity, String password);
    Optional<PlayerEntity> findByEmailAndPassword(String emailIdentity, String password);
